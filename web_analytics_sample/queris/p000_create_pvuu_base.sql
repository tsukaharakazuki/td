...
(
  ...
  WHERE
    TD_INTERVAL(time, '-${base_term}d/now', 'JST') AND
...
${check_td_ssc_id}  td_ssc_id ,
  ...
  td_ref_host ,
  CASE
    WHEN td_ref_host = 'seishin-rugby.com' THEN '清真学園ラグビー部'
    WHEN td_ref_host = 'www.seishin-web.jp' THEN '清真学園学校HP'
    ...
    WHEN td_ref_host RLIKE 'www.google.%' THEN 'Google(Other)'
