SELECT
	...
	${(Object.prototype.toString.call(media[params].pv_first_regular_other_process.regular) === '[object Array]')?','+media[params].pv_first_regular_other_process.regular.join():''}
FROM
